...
A script to format unified git diffs according to [.clang-format](../../reversedbitcoin/.clang-format).
...
Run this script from the root of the source tree (`reversedbitcoin/`) to find circular dependencies in the source code.
