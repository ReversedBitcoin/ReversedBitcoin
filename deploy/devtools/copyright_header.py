...
EXCLUDE = [
    # auto generated:
    'reversedbitcoin/qt/bitcoinstrings.cpp',
    'reversedbitcoin/reversedbitcoinseeds.h',
    # other external copyrights:
    'reversedbitcoin/tinyformat.h',
...
EXCLUDE_DIRS = [
    # git subtrees
    "reversedbitcoin/crypto/ctaes/",
    "reversedbitcoin/leveldb/",
    "reversedbitcoin/secp256k1/",
    "reversedbitcoin/univalue/",
]
