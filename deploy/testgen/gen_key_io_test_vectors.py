...
Usage:
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py valid 50 > ../../reversedbitcoin/test/data/key_io_valid.json
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py invalid 50 > ../../reversedbitcoin/test/data/key_io_invalid.json
'''
...
bech32_templates = [
  ...
  ('"reversedbitcoin',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"reversedbitcoin',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"reversedbitcoin',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('treversedbitcoin',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('treversedbitcoin',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('treversedbitcoin',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rreversedbitcoin',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rreversedbitcoin',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rreversedbitcoin', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('treversedbitcoin',   17, 32, False, False, False),
  ('rreversedbitcoin',  3,  1, False, False, False),
  ('reversedbitcoin',   15, 41, False, False, False),
  ('treversedbitcoin',    0, 16, False, False, False),
  ('rreversedbitcoin',  0, 32, True,  False, False),
  ('reversedbitcoin',    0, 16, True,  False, False),
  ('treversedbitcoin',    0, 32, False, True,  False),
  ('rreversedbitcoin',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['reversedbitcoin', 'treversedbitcoin', 'rreversedbitcoin']:
