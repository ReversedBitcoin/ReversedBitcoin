    ...
    m_network_style(networkStyle)
{
    ...
    // Create status bar
    statusBar();
    statusBar()->setStyleSheet("QWidget { background-color: #030101; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} ");
 ...
 // Social icons
    ...
    website->setMinimumSize(QSize(42, 42));
    website->setMaximumSize(QSize(42, 42));
...
#endif // QT_NO_TOOLTIP
    website->setText(QApplication::translate("OverviewPage", "<a href=\"https://reversedbitcoin.org\"><img src=\":/icons/website\" width=\"36\" height=\"36\"></a>", nullptr));


    QLabel* explorer = new QLabel();
    explorer->setObjectName(QStringLiteral("explorer"));
    explorer->setMinimumSize(QSize(42, 42));
    explorer->setMaximumSize(QSize(42, 42));
...
#endif // QT_NO_TOOLTIP
    explorer->setText(QApplication::translate("OverviewPage", "<a href=\"https://explorer.reversedbitcoin.org\"><img src=\":/icons/explorer\" width=\"36\" height=\"36\"></a>", nullptr));


    QLabel* pool= new QLabel();
    pool->setObjectName(QStringLiteral("pool"));
    pool->setMinimumSize(QSize(42, 42));
    pool->setMaximumSize(QSize(42, 42));
...
#endif // QT_NO_TOOLTIP
    pool->setText(QApplication::translate("OverviewPage", "<a href=\"https://pool.reversedbitcoin.org\"><img src=\":/icons/pool\" width=\"36\" height=\"36\"></a>", nullptr));


    QLabel* wallet= new QLabel();
    wallet->setObjectName(QStringLiteral("wallet"));
    wallet->setMinimumSize(QSize(42, 42));
    wallet->setMaximumSize(QSize(42, 42));
    wallet->setBaseSize(QSize(0, 0));
    wallet->setCursor(QCursor(Qt::PointingHandCursor));
    wallet->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    wallet->setOpenExternalLinks(true);
#ifndef QT_NO_TOOLTIP
    wallet->setToolTip(QApplication::translate("OverviewPage", "Web Wallet", nullptr));
#endif // QT_NO_TOOLTIP
    wallet->setText(QApplication::translate("OverviewPage", "<a href=\"https://myreversedbitcoin.org\"><img src=\":/icons/wallet\" width=\"36\" height=\"36\"></a>", nullptr));


    QLabel* discord = new QLabel();
    discord->setObjectName(QStringLiteral("discord"));
    discord->setMinimumSize(QSize(42, 42));
    discord->setMaximumSize(QSize(42, 42));
...
#endif // QT_NO_TOOLTIP
    discord->setText(QApplication::translate("OverviewPage", "<a href=\"https://discord.gg/qS8e6Y8EZb\"><img src=\":/icons/discord\" width=\"36\" height=\"36\"></a>", nullptr));


    frameSocialLayout->addWidget(website);
    frameSocialLayout->addWidget(explorer);
    frameSocialLayout->addWidget(pool);
    frameSocialLayout->addWidget(wallet);
    ...
    unitDisplayControl->setStyleSheet("QLabel { background-color: #030101; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} QLabel::item:selected { background-color: #232323;} QLabel::item:pressed { background-color: #232323;}");
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #0D0F14; font-size: 0px; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 2px; color: transparent; border: 1px solid grey; border-radius: 10px; padding: 1px; text-align: center; min-width: 400px; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #0000CD, stop: 1 #C95700); font-size: 0px; border-radius: 14px; margin: 0px; max-height: 2px; min-width: 400px; } ");
...
void BitcoinGUI::createActions()
{
...
#endif
    sendCoinsAction->setStatusTip(tr("Send coins to a ReversedBitcoin address"));
...
#endif
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reversedbitcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ReversedBitcoin addresses to prove you own them"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ReversedBitcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a reversedbitcoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ReversedBitcoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::createMenuBar()
{
    ...
    appMenuBar = menuBar();
    appMenuBar->setStyleSheet("QMenuBar { background-color: #030101; font-weight:normal; text-align:center; font-family: Arial, sans-recif; font-size: 10px; text-transform: uppercase; color: #C0C0C0;} QMenuBar::item:selected { background-color: #141413;} QMenu { background-color: #060607; font-weight:normal; text-align:center; font-family: Arial, sans-recif; font-size: 10px; text-transform: uppercase; color: #C0C0C0;} QMenu::item:selected { background-color: rgba(3, 70, 130, 0.2);} ");
// QMenuBar::item { min-width: 40px; margin-left:20px; margin-right:20px; }
#endif
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to ReversedBitcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
