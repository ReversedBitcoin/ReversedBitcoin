...
//
//     QT_QPA_PLATFORM=xcb     reversedbitcoin/qt/test/test_reversedbitcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows reversedbitcoin/qt/test/test_reversedbitcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   reversedbitcoin/qt/test/test_reversedbitcoin-qt  # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: reversedbitcoin:")) != -1);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_reversedbitcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
