    ...
    transactionView(nullptr), abandonAction(nullptr), bumpFeeAction(nullptr), columnResizingFixer(nullptr)
{
 ...
 //   hlayout->setStyleSheet("QHBoxLayout { background-color: #040101; font-weight:normal; text-align:center; font-family: Arial, sans-recif; font-size: 10px; text-transform: uppercase; color: #C0C0C0;}");
