...
bool MemPoolAccept::Finalize(ATMPArgs& args, Workspace& ws)
{
    ...
    for (CTxMemPool::txiter it : allConflicting)
    {
        LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s RVB additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	if (nHeight > 0 && nHeight <= 210000)
		...
		nSubsidy = 6.25 * COIN;
	else if (nHeight > 1260000 && nHeight <= 1470000)
		nSubsidy = 12.5 * COIN;
	else if (nHeight > 1470000 && nHeight <= 1680000)
		nSubsidy = 25 * COIN;
	else if (nHeight > 1680000 && nHeight <= 1889999)
		nSubsidy = 50 * COIN;
	else if (nHeight == 1890000)
		nSubsidy = 41065.625 * COIN;
	else
		nSubsidy = 0 * COIN;
 ...
 *
 * Non-static (and re-declared) in reversedbitcoin/test/txvalidationcache_tests.cpp
 */
