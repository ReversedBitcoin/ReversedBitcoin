...
static UniValue getpeerinfo(const JSONRPCRequest& request)
{
            ...
            "    \"subver\": \"/RVB:1.0.0/\",  (string) The string version\n"
    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw std::runtime_error(
            RPCHelpMan{"addnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:11388\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:11388\", \"onetry\"")
                },
            }.ToString());
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
            RPCHelpMan{"disconnectnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:11388\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:11388\"")
...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:11388\",  (string) ReversedBitcoin server IP and port we're connected to\n"
...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
            ...
            "  \"subversion\": \"/RVB:x.x.x/\",     (string) the server subversion string\n"
