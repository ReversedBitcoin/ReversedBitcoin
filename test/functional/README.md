...
- `/reversedbitcoin/rpc/*` for RPCs
- `/reversedbitcoin/wallet/rpc*` for wallet RPCs
- `ProcessMessage()` in `/reversedbitcoin/net_processing.cpp` for parsing P2P messages
...
with reversedbitcoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a reversedbitcoind.  `P2PInterface`
...
Basic code to support P2P connectivity to a reversedbitcoind.
