...
"""Verify that starting reversedbitcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reversedbitcoin with -h for help text")
        ...
        self.log.info("Start reversedbitcoin with -version for version information")
        ...
        self.log.info("Start reversedbitcoind with -fakearg to make sure it does not start")
