...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def bitcoin_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/reversedbitcoin/reversedbitcoin-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `reversedbitcoin-wallet help` raises an error. Use `reversedbitcoin-wallet -help`.
