...
SOURCES = [
    "reversedbitcoin/rpc/server.cpp",
    "reversedbitcoin/rpc/blockchain.cpp",
    "reversedbitcoin/rpc/mining.cpp",
    "reversedbitcoin/rpc/misc.cpp",
    "reversedbitcoin/rpc/net.cpp",
    "reversedbitcoin/rpc/rawtransaction.cpp",
    "reversedbitcoin/wallet/rpcwallet.cpp",
]
# Source file (relative to root) containing conversion mapping
SOURCE_CLIENT = 'reversedbitcoin/rpc/client.cpp'
