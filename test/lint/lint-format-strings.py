...
FALSE_POSITIVES = [
    ("reversedbitcoin/dbwrapper.cpp", "vsnprintf(p, limit - p, format, backup_ap)"),
    ("reversedbitcoin/index/base.cpp", "FatalError(const char* fmt, const Args&... args)"),
    ("reversedbitcoin/netbase.cpp", "LogConnectFailure(bool manual_connection, const char* fmt, const Args&... args)"),
    ("reversedbitcoin/util/system.cpp", "strprintf(_(COPYRIGHT_HOLDERS).translated, COPYRIGHT_HOLDERS_SUBSTITUTION)"),
    ("reversedbitcoin/wallet/wallet.h",  "WalletLogPrintf(std::string fmt, Params... parameters)"),
    ("reversedbitcoin/wallet/wallet.h", "LogPrintf((\"%s \" + fmt).c_str(), GetDisplayName(), parameters...)"),
    ("reversedbitcoin/logging.h", "LogPrintf(const char* fmt, const Args&... args)"),
]
