...
export LC_ALL=C
KNOWN_VIOLATIONS=(
    "reversedbitcoin/bitcoin-tx.cpp.*stoul"
    "reversedbitcoin/bitcoin-tx.cpp.*trim_right"
    "reversedbitcoin/dbwrapper.cpp.*stoul"
    "reversedbitcoin/dbwrapper.cpp:.*vsnprintf"
    "reversedbitcoin/httprpc.cpp.*trim"
    "reversedbitcoin/init.cpp:.*atoi"
    "reversedbitcoin/qt/rpcconsole.cpp:.*atoi"
    "reversedbitcoin/rest.cpp:.*strtol"
    "reversedbitcoin/test/dbwrapper_tests.cpp:.*snprintf"
    "reversedbitcoin/torcontrol.cpp:.*atoi"
    "reversedbitcoin/torcontrol.cpp:.*strtol"
    "reversedbitcoin/util/strencodings.cpp:.*atoi"
    "reversedbitcoin/util/strencodings.cpp:.*strtol"
    "reversedbitcoin/util/strencodings.cpp:.*strtoul"
    "reversedbitcoin/util/strencodings.h:.*atoi"
    "reversedbitcoin/util/system.cpp:.*atoi"
)

REGEXP_IGNORE_EXTERNAL_DEPENDENCIES="^reversedbitcoin/(crypto/ctaes/|leveldb/|secp256k1/|tinyformat.h|univalue/)"
